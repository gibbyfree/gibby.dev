...
var CalHeatMap = function() {
	...
	this.paint = function(navigationDir) {
		...
		rect
			...
			.attr("x", function(d) { return self.positionSubDomainX(d.t, false); })
			...
			.call(function(selection) {
				...
				if (options.tooltip) {
					selection.on("mouseover", function(d) {
						...
						var tooltipPositionX = self.positionSubDomainX(d.t, true) - self.tooltip[0][0].offsetWidth/2 + options.cellSize/2;
		...
		if (options.subDomainTextFormat !== null) {
			rect
				...
				.attr("x", function(d) { return self.positionSubDomainX(d.t, false) + options.cellSize/2; })
