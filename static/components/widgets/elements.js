...
const q = 2, Lt = 4, zt = 8, Qn = 1 << 24, he = 16, Fe = 32, Pe = 64, pn = 128, ee = 512, B = 1024, H = 2048, Te = 4096, Z = 8192, ke = 16384, Vt = 32768, dt = 65536, Mn = 1 << 17, er = 1 << 18, Ge = 1 << 19, ai = 1 << 20, Ee = 1 << 25, Ue = 32768, Xt = 1 << 21, gn = 1 << 22, Ne = 1 << 23, Kt = Symbol("$state"), ci = Symbol("legacy props"), Xe = new class extends Error {
  constructor() {
    super(...arguments);
...
var nt, rt, Be, it, kt, st, ft, lt, de, tn, nn, cr;
const kn = class kn {
  constructor() {
    y(this, de);
    R(this, "committed", !1);
  ...
  process(t) {
    ...
    if (this.is_deferred())
      ...
      h(this, nt).clear(), h(this, Be) === 0 && F(this, de, cr).call(this), S = null, Fn(r), Fn(n), (s = h(this, kt)) == null || s.resolve();
    }
    L = null;
  }
  /**
  ...
  settled() {
    return (h(this, kt) ?? $(this, kt, Xn())).promise;
  }
  static ensure() {
    if (S === null) {
      const t = S = new kn();
...
nt = new WeakMap(), rt = new WeakMap(), Be = new WeakMap(), it = new WeakMap(), kt = new WeakMap(), st = new WeakMap(), ft = new WeakMap(), lt = new WeakMap(), de = new WeakSet(), /**
...
function dr(e) {
  ...
  try {
    for (var n; ; ) {
      if (ki(), K.length === 0 && (S == null || S.flush(), K.length === 0))
...
function Fn(e) {
  ...
  if (t !== 0) {
    for (var n = 0; n < t; ) {
      var r = e[n++];
      if ((r.f & (ke | Z)) === 0 && St(r) && (ie = /* @__PURE__ */ new Set(), Et(r), r.deps === null && r.first === null && r.nodes === null && (r.teardown === null && r.ac === null ? Or(r) : r.fn = null), (ie == null ? void 0 : ie.size) > 0)) {
        Ie.clear();
        for (const s of ie) {
          if ((s.f & (ke | Z)) !== 0) continue;
          const i = [s];
          let f = s.parent;
          for (; f !== null; )
...
var G, xt, oe, je, ue, X, z, ae, $e, Re, He, we, ot, ze, ut, at, ye, jt, O, pr, gr, rn, Nt, Ot, sn;
class Ri {
  /**
  ...
  error(t) {
    ...
    const f = () => {
      ...
      s = !0, i && $i(), xe.ensure(), $(this, He, 0), h(this, ae) !== null && tt(h(this, ae), () => {
        $(this, ae, null);
...
G = new WeakMap(), xt = new WeakMap(), oe = new WeakMap(), je = new WeakMap(), ue = new WeakMap(), X = new WeakMap(), z = new WeakMap(), ae = new WeakMap(), $e = new WeakMap(), Re = new WeakMap(), He = new WeakMap(), we = new WeakMap(), ot = new WeakMap(), ze = new WeakMap(), ut = new WeakMap(), at = new WeakMap(), ye = new WeakMap(), jt = new WeakMap(), O = new WeakSet(), pr = function() {
  try {
  ...
  t && ($(this, z, le(() => t(h(this, G)))), Oe(() => {
    ...
    $(this, X, F(this, O, Nt).call(this, () => (xe.ensure(), le(() => h(this, je).call(this, n))))), h(this, we) > 0 ? F(this, O, Ot).call(this) : (tt(
      /** @type {Effect} */
      h(this, z),
      () => {
        $(this, z, null);
  ...
  return r && n.set("length", /* @__PURE__ */ pe(
    ...
    e,
    {
      ...
      set(l, u, o, c) {
        ...
        if (d === void 0)
          (!a || (x = et(l, u)) != null && x.writable) && (d = f(() => /* @__PURE__ */ pe(void 0)), ge(d, Qe(o)), n.set(u, d));
        else {
          a = d.v !== D;
          var _ = f(() => Qe(o));
          ge(d, _);
        ...
        if (g != null && g.set && g.set.call(c, o), !a) {
          if (r && typeof u == "string") {
            ...
            Number.isInteger(E) && E >= k.v && ge(k, E + 1);
          }
          mt(s);
        }
        return !0;
...
function on() {
  if (Pn === void 0) {
    ...
    kr = et(t, "firstChild").get, xr = et(t, "nextSibling").get, In(e) && (e.__click = void 0, e.__className = void 0, e.__attributes = null, e.__style = void 0, e.__e = void 0), In(n) && (n.__t = void 0);
  }
}
function Me(e = "") {
...
function zn(e, t, n, r, s, i = null) {
  ...
  var p = Ar(() => {
    ...
    if (A) {
      var E = mi(f) === vn;
      E !== (g === 0) && (f = Qt(), te(f), De(!1), k = !0);
    }
    for (var x = /* @__PURE__ */ new Set(), T = (
      /** @type {Batch} */
      S
    ), Y = Li(), b = 0; b < g; b += 1) {
  ...
  for (g = 0; g < i; g += 1) {
    ...
    if ((_.f & Ee) !== 0)
      if (_.f ^= Ee, _ === l)
        ...
        var k = o ? o.next : l;
        _ === e.effect.last && (e.effect.last = _.prev), _.prev && (_.prev.next = _.next), _.next && (_.next.prev = _.prev), Ae(e, o, _), Ae(e, _, k), wt(_, k, n), o = _, d = [], a = [], l = o.next;
        continue;
      }
    if ((_.f & Z) !== 0 && (Mr(_), (xn = (Ze = _.nodes) == null ? void 0 : Ze.a) == null || xn.unfix(), (c ?? (c = /* @__PURE__ */ new Set())).delete(_)), _ !== l) {
      if (u !== void 0 && u.has(_)) {
...
function Rt(e, t, n, r) {
  ...
  if (((x = g.nodes).t ?? (x.t = [])).push(_), s && cn) {
    var k = l;
    if (!k) {
      for (var E = (
        /** @type {Effect | null} */
...
function Bt(e, t, n, r, s) {
  ...
  return _.onfinish = () => {
    ...
    if (E > 0) {
      ...
      if (o)
        for (var Y = Math.ceil(E / 16.666666666666668), b = 0; b <= Y; b += 1) {
          var M = g + k * d(b / Y), re = Vn(o(M, 1 - M));
          x.push(re), T || (T = re.overflow === "hidden");
        }
    ...
    _ = e.animate(x, { duration: E, fill: "forwards" }), _.onfinish = () => {
...
function Wn(e, { from: t, to: n }, r = {}) {
  ...
  var d = $s(e), a = e.clientWidth / n.width / d, v = e.clientHeight / n.height / d, p = t.left + t.width * o, _ = t.top + t.height * c, g = n.left + n.width * o, k = n.top + n.height * c, E = (p - g) * a, x = (_ - k) * v, T = t.width / n.width, Y = t.height / n.height;
  return {
    delay: s,
    duration: typeof i == "function" ? i(Math.sqrt(E * E + x * x)) : i,
    easing: f,
    css: (b, M) => {
      var re = M * E, I = M * x, Ke = b + M * T, Ze = b + M * Y;
...
function ys({ fallback: e, ...t }) {
  ...
  function s(f, l, u) {
    const {
      ...
      easing: d = Gr
    } = Gn(Gn({}, t), u), a = f.getBoundingClientRect(), v = l.getBoundingClientRect(), p = a.left - v.left, _ = a.top - v.top, g = a.width / v.width, k = a.height / v.height, E = Math.sqrt(p * p + _ * _), x = getComputedStyle(l), T = x.transform === "none" ? "" : x.transform, Y = +x.opacity;
    return {
      delay: o,
      ...
      css: (b, M) => `
			   ...
			   transform: ${T} translate(${M * p}px,${M * _}px) scale(${b + (1 - b) * g}, ${b + (1 - b) * k});
		   `
    };
  }
  function i(f, l, u) {
...
var ms = /* @__PURE__ */ En('<div role="button" tabindex="0" class="svelte-1k4kus3"> </div>'), bs = /* @__PURE__ */ En('<div role="button" tabindex="0" class="svelte-1k4kus3"> </div>'), Es = /* @__PURE__ */ En('<div class="container svelte-1k4kus3"><div class="boingers svelte-1k4kus3"></div> <div class="boingers svelte-1k4kus3"></div></div>');
const ks = {
  hash: "svelte-1k4kus3",
  code: ".container.svelte-1k4kus3 {width:300px;height:200px;display:flex;justify-content:space-between;}.boingers.svelte-1k4kus3 {display:grid;grid-template-rows:repeat(3, 1fr);grid-template-columns:repeat(2, 1fr);grid-gap:10px;}.boingers.svelte-1k4kus3 div:where(.svelte-1k4kus3) {width:50px;height:50px;display:flex;justify-content:center;align-items:center;color:#eee;font-weight:bold;border-radius:2px;cursor:pointer;}"
};
function xs(e, t) {
  ir(t, !0), as(e, ks);
...
Ji(["click", "keydown"]);
customElements.define("boing-toggle", ps(xs, { color: {} }, [], [], !0));
