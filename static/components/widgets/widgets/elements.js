...
const Ki = {
  hash: "svelte-1i1lpz1",
  code: `.box.svelte-1i1lpz1 {border:1px solid currentColor;padding:12px;border-radius:12px;font-family:inherit;}.prompt.svelte-1i1lpz1 {margin:0 0 12px 0;font-weight:500;}.items.svelte-1i1lpz1 {display:flex;flex-direction:column;gap:8px;}.item.svelte-1i1lpz1 {padding:8px 12px;background:rgba(128, 128, 128, 0.1);border-radius:6px;cursor:grab;user-select:none;transition:opacity 0.2s,
            transform 0.2s;}.item.svelte-1i1lpz1:hover {background:rgba(128, 128, 128, 0.2);}.item.dragging.svelte-1i1lpz1 {opacity:0.5;cursor:grabbing;}`
};
function Gi(e, t) {
  Mn(t, !0), Li(e, Ki);
